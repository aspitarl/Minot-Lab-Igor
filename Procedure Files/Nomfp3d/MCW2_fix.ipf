...
Window MCW() : Panel
	...
	PopupMenu dataset,pos={169,336},size={106,22}
	PopupMenu dataset,mode=4,popvalue="CNTAtlas_calc",value= #"\"Atlas_zero;Columbia;CNTAtlas_epd;CNTAtlas_calc\""
	Button Chiral,pos={165,305},size={60,20},proc=ChiralButon,title="Do Chiral"
	...
	PopupMenu smormet,pos={216,370},size={46,22}
	PopupMenu smormet,mode=1,popvalue="SM",value= #"\"SM;Met\""
	Button dispreslist,pos={163,371},size={50,20},proc=displayreslist,title="Dispreslist"
	Button dispreslist,fColor=(61440,61440,61440)
	CheckBox Samegraph,pos={303,27},size={77,14},title="Same Graph",value= 1
	...
	Button loadapp,pos={147,24},size={62,19},proc=Loadappbutton,title="Load App"
	Button loadapp,fColor=(61440,61440,61440)
	Button logright,pos={309,81},size={50,20},proc=logrightbutton,title="Log Right"
	...
	SetVariable prestr,pos={87,81},size={136,16},title="Prepend string"
	SetVariable prestr,value= _STR:""
	Button Notes,pos={493,419},size={50,20},proc=Notesbutton,title="Notes"
	Button LeftRight,pos={243,80},size={50,20},proc=LeftRightButton,title="LeftRight"
	SetVariable headerlines,pos={222,26},size={66,16},title="# lines",value= _NUM:2
	Button DeviceTable,pos={492,301},size={63,20},proc=Devtablebutton,title="Dev Table"
	Button Altergraphbutton,pos={239,55},size={63,21},proc=Altergraphbutton,title="Alter Graph"
	SetVariable Altergraphnum,pos={309,57},size={74,16},title="Type",value= _NUM:7
	Button gatebias,pos={445,332},size={67,21},proc=Resultstablebuttion,title="Results table"
	ListBox Peaklist,pos={91,304},size={58,89}
	...
	Button Calcabcs,pos={289,338},size={50,20},proc=Calcabcsbutton,title="Calc Abs"
	...
	CheckBox appendright,pos={276,371},size={78,14},title="Append right",value= 0
	Button annotate,pos={13,19},size={50,20},proc=annbutton,title="ann"
	SetVariable devicenumber,pos={375,302},size={89,16},title="Dev num"
	SetVariable devicenumber,value= _NUM:0
	CheckBox peratom,pos={276,395},size={67,14},title="Per Atom?",value= 0
...
setdatafolder root:QE
	...
	make/o/n=5  gates,bias,QY_fit, Length
