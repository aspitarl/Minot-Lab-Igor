...
variable type =chilib[row][2]

variable n =chilib[row][0]
variable m =chilib[row][1]

print ("n , m: " + num2str(n) + " , " + num2str(m))
print "type: " + num2str(type)
...
for(i=0;i<=numpeaks-1;i=i+1)   
	...
	print num2str(p), num2str(currentpeaks[i])	
